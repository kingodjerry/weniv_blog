...
const bloglistCardStyle = `lg:max-w-sm overflow-hidden bg-white transition duration-200 ease-in-out transform hover:-translate-y-1 hover:scale-105 cursor-pointer col-span-1 w-auto cursor-pointer`;
...
const bloglistCardTitleStyle = `font-bold text-2xl mb-3 hover:underline`; // 제목 hover 시 밑줄 추가 ✅
