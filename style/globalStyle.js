...
const bloglistCardStyle = `lg:max-w-sm overflow-hidden bg-white transition duration-200 ease-in-out transform cursor-pointer col-span-1 w-auto cursor-pointer`;
